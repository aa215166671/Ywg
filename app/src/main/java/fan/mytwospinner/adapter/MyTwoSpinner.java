package fan.mytwospinner.adapter;
...
public class MyTwoSpinner extends LinearLayout implements View.OnClickListener {
    ...
    private void initView() {
        ...
        iv_select_action_arrow.setOnClickListener(this);
...
//        ll_spinner_container.startAnimation(animation);
        ...
        morelist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView <?> parent, View view,
                ...
                content = DataModel.MORELISTVIEWTXT[mainSelectPostion][position];
...
//            map.put("img", DataModel.LISTVIEWIMG[i]);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_select_action_arrow:
                if (isContainerShow) {
                    hide();
                } else {
                    show();
