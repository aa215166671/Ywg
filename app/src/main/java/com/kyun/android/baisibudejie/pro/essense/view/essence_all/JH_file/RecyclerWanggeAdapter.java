...
public class RecyclerWanggeAdapter extends RecyclerView.Adapter<RecyclerWanggeAdapter.ViewHolder> implements View.OnClickListener {
    private static final String TAG = RecyclerWanggeAdapter.class.getSimpleName();
    ...
    public RecyclerWanggeAdapter(Context context, List <Bean.DataBean> data) {
        this.data = data;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            sousuo = (Button) itemView.findViewById(R.id.mj_sousuo);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(R.layout.mj_remensousuo, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.sousuo.setText(data.get(position).getText());//加载数据
