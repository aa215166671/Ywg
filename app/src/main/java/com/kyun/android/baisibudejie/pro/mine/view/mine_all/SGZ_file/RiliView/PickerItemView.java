...
public class PickerItemView extends View {
    ...
    private int minFontSizePercent=32  ;

    private int maxFontSizePercent = 42;

    private int normalFontColor = 0xff3EB9E6;//正常的文字颜色

    private int pressFontColor = 0xffF90000;//选中的文字颜色
