package com.kyun.android.baisibudejie.pro.base.view.views.navigation;
...
public abstract class NavigationBuilderAdapter implements NavigationBuilder {
    ...
    protected void setTitleTextView(int viewId, String title, View.OnClickListener onClickListener){

        TextView textView=getContentView().findViewById(viewId);
