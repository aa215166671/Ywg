...
import com.kyun.android.baisibudejie.pro.essense.view.essence_all.BB_file.utils.picutils.ToastAlert;
import com.kyun.android.baisibudejie.pro.essense.view.essence_all.BB_file.utils.viewdialog.PictureSpinView;
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int arg0) {
                if (Imageutils.getBackListeners()!=null) {
                    Imageutils.getBackListeners().backMethod(arg0);
                }
