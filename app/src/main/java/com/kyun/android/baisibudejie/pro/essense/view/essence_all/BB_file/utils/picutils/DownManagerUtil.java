...
import com.kyun.android.baisibudejie.pro.essense.view.essence_all.BB_file.utils.viewdialog.DownLoadDialog;
...
public class DownManagerUtil {
    ...
    public void downLoad(List<String> urls, String type) {
        ...
        String path = Imageutils.DOWN_PATH + File.separator + System.currentTimeMillis();
