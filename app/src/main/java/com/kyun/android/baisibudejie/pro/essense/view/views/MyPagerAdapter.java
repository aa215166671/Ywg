package com.kyun.android.baisibudejie.pro.essense.view.views;
...
public class MyPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.fragment_essence_cardview_item,container,false);
    ...
    private class LoadBitmapTask extends AsyncTask<Integer,Void,Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            ...
            options.inSampleSize = calculateInSampleSize(options,
                    dp2px(mContext,300),
                    dp2px(mContext,200));          //2、根据ImageView的宽高计算所需要的采样率
